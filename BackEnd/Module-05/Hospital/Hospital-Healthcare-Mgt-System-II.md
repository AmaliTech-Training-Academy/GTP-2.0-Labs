...
This phase transforms the Hospital Management System into a **Spring Boot web application**, focusing on building RESTful and GraphQL APIs that interact with the system’s database.

It applies enterprise backend concepts including **validation, exception handling, AOP, and OpenAPI documentation** to create a scalable and maintainable healthcare management platform.
...
* Apply Spring Boot configuration principles, IoC, and Dependency Injection for modular design.
...
* Constructor-based dependency injection consistently applied
...
**User Story 4.1**
As a frontend developer, I want to retrieve data using GraphQL queries and mutations.

**Acceptance Criteria**

* GraphQL schema defined for key entities (patients, doctors, appointments)
...
* @Before, @After, and @Around aspects implemented
* Logging applied to critical service methods
* AOP behavior documented in project report
...
| Testing                | Postman, JavaFX, or web frontend                         |
...
| Validation & Exception Handling | DTO validation and centralized error handling |
| API Documentation               | Swagger/OpenAPI documentation                 |
| AOP Implementation              | Logging and monitoring aspects                |
| GraphQL Schema                  | Queries and mutations defined                 |
| Performance Report              | REST vs GraphQL comparison analysis           |
| README File                     | Setup and API testing instructions            |
...
| REST API Development            | CRUD functionality and REST architecture | 20     |
| Validation & Documentation      | Validation, error handling, OpenAPI      | 20     |
| GraphQL Integration             | Schema, queries, mutations, comparison   | 15     |
